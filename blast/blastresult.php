...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../static/bootstrap-table-master/dist/bootstrap-table.css">
        <link rel="stylesheet" type="text/css" href="../static/bootstrap-table-fixed-columns-master/bootstrap-table-fixed-columns.css">
	...
	if ($alignmentView) {
		...
		if(!$opt || $opt == 'wait') {
			...
			if($cutoff_count == 0) {
				...
				echo "<p><table class='table table-striped'  data-toggle='table' data-height='380' data-show-refresh='true' data-show-toggle='true' data-search='true' data-show-columns='true'>";
				echo "<thead><tr align='center'><th  data-sortable='true'>Query</th><th data-sortable='true'>Subject</th><th data-sortable='true'>Score</th><th data-sortable='true'>Identities (Query length)</th><th data-sortable='true'>Percentage</th><th data-sortable='true'>Expect</th></tr></thead>";
				echo "<tbody>";
...
?>
    ...
    <script src="../static/bootstrap-table-fixed-columns-master/bootstrap-table-fixed-columns.js" type="text/javascript"></script>
