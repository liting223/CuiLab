...
function examp() {
	var attitude=document.getElementsByName("Morex");
	var value = 0;
	for(var i=0;i<attitude.length;i++){
		if(attitude[i].checked == true){
			value = attitude[i].value;
			if (value == 'V2'){
				document.getElementById("querySeq").value = 'HORVU.MOREX.r2.1HG0000021' + '\n' + 'HORVU.MOREX.r2.1HG0000030'+ '\n' + 'HORVU.MOREX.r2.1HG0000040'+ '\n' + 'HORVU.MOREX.r2.1HG0000050'+ '\n' + 'HORVU.MOREX.r2.1HG0000060'+ '\n' + 'HORVU.MOREX.r2.1HG0000070';
			}
			else if (value == 'V3'){
				document.getElementById("querySeq").value = 'HORVU.MOREX.r3.1HG0000030' + '\n' + 'HORVU.MOREX.r3.1HG0000040'+ '\n' + 'HORVU.MOREX.r3.1HG0000050'+ '\n' + 'HORVU.MOREX.r3.1HG0000060'+ '\n' + 'HORVU.MOREX.r3.1HG0000070'+ '\n' + 'HORVU.MOREX.r3.1HG0000080';
			}
		}
	}
}
...
function clear() {
	document.getElementById("querySeq").value = '';
}